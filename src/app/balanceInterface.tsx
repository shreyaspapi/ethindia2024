		...
		<Card className="mx-auto w-full max-w-md bg-white shadow-xl dark:bg-gray-900">
			<CardContent className="p-8">
				<div className="mb-8 text-center">
					...
					<p className="text-sm text-gray-500 dark:text-gray-400">Checking balances on {chain}</p>
				</div>
				...
				<div className="space-y-6">
					...
					<div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
						...
						<div className="flex items-center space-x-3">
							...
							<span className="font-mono text-sm text-gray-800 dark:text-gray-200">{address}</span>
						</div>
					</div>
								...
								Object.entries(balances).map(([token, balance]) => (
									...
									>
										<div className="flex items-center space-x-3">
											...
											<span className="font-medium text-gray-900 dark:text-white">{token}</span>
										</div>
